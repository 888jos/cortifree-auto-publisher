...
export default function Editor({params}:{params:Promise<{id:string}>}){
 ...
 useEffect(()=>{if(!dirty||!carousel||!id)return;const timer=window.setTimeout(()=>{void save(false,true)},900);return()=>window.clearTimeout(timer)},[overrides,dirty,id,carousel]);
