...
export type HeavyJobKind = "HEALTHCHECK" | "APPLY_REVIEW_PATCH" | "SCHEDULE_APPROVED_POST" | "RENDER_CAROUSEL" | "GOOGLE_SYNC" | "PERSONA_ASSET_ARCHIVE" | "MODELARK_ORPHAN_RECOVERY" | "AUTONOMY_RUN" | "BAD_REFERENCE_CLEANUP";
