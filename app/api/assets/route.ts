...
export async function GET(request: Request) {
  try {
    ...
    return Response.json({ assets: grouped, previews, total: rows.length, source: "supabase", preview_limit: previewLimit });
  } catch (error) {
